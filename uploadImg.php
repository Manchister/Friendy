...
if (isset($_FILES['image']['name'])) {
    ...
    $uploaddir = $_SERVER['DOCUMENT_ROOT'] . '/mr-friendy/assets/img/profile_pics';
    //Set File name	
...
<div>
    ...
    <div class="panel panel-primary">
        <h4 class="panel-heading text-center text-capitalize">Update your profile picture</h4>
        <div class="panel-body">
            ...
            <div id="formExample">
                ...
                <p><b> <?= $msg ?> </b></p>
                <h5 class="panel-title has-warning text-center">Choose an image file to use.</h5><hr>
                <form action="uploadImg.php" method="post"  enctype="multipart/form-data" style="display: flex;flex-direction: column;align-items: center;">
                    <input type="file" accept="image/*" id="image" name="image" style="width: 200px;" /><br /><br />
            ...
            <?php if ($imgSrc) { //if an image has been uploaded display cropping area ?>
                ...
                <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: 20px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
                    ...
                    <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
                        <form action="uploadImg.php" method="post" onsubmit="return checkCoords();">
                            ...
                            <input type="submit" value="Save" style="width:100px; height:30px;" class="btn btn-success"  />
                        </form>
                    </div>
                    ...
                    <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
                        <form action="uploadImg.php" method="post">
                            ...
                            <input type="submit" value="Cancel Crop" style="width:100px; height:30px;" class="btn btn-default"  />
                        </form>
                    </div>            
